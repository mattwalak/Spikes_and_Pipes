...
obstacles_list[39] = lb.newFan_(speed, false, util.newPoint(0,0), 7, 0, 8000, 15, nil, lb.spike2Edge(0,0,0), 3)
obstacles_list[44] = lb.newFan_(speed, true, util.newPoint(0,0), 7, 0, 8000, 15, nil, lb.spike2Edge(0,0,0), 3)
obstacles_list[49] = lb.newFan_(speed, false, util.newPoint(0,0), 7, 0, 8000, 15, nil, lb.spike2Edge(0,0,0), 3)
